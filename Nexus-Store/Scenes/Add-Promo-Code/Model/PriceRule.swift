...
struct SinglePriceRule:Codable{
    let priceRules: PriceRule

    enum CodingKeys: String, CodingKey {
        case priceRules = "price_rule"
    }
}
// MARK: - PriceRule
struct PriceRule: Codable {
    ...
    let entitledVariantIDS, entitledCollectionIDS, entitledCountryIDS, prerequisiteProductIDS: [Int?]
    let prerequisiteVariantIDS: [Int?]
    let prerequisiteCollectionIDS: [Int]
    let customerSegmentPrerequisiteIDS, prerequisiteCustomerIDS: [Int?]
